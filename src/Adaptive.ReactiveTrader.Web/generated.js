...
Rx.Observable.prototype.conflate = function (minimumUpdatePeriodMs, scheduler) {
    ...
    return Rx.Observable.create(function (observer) {
        ...
        var subscription = _this.observeOn(scheduler)
        ...
        }, function (ex) { return observer.onError(ex); }, function () {
...
Rx.Observable.prototype.detectStale = function (stalenessPeriodMs, scheduler) {
    ...
    return Rx.Observable.create(function (observer) {
        ...
        var sourceSubscription = _this.subscribe(function (x) {
            ...
            scheduleStale();
        }, function (ex) { return observer.onError(ex); }, function () { return observer.onCompleted(); });
        scheduleStale();
...
var TradeFactory = /** @class */ (function () {
    ...
    TradeFactory.prototype.create = function (trade) {
        return new Trade(trade.CurrencyPair, trade.Direction == DirectionDto.Buy ? Direction.Buy : Direction.Sell, trade.Notional, trade.SpotRate, trade.Status == TradeStatusDto.Done ? TradeStatus.Done : TradeStatus.Rejected, trade.TradeDate, trade.TradeId, trade.TraderName, trade.ValueDate, trade.DealtCurrency);
    };
    return TradeFactory;
}());
var TradeStatus;
...
var CurrencyPair = /** @class */ (function () {
    function CurrencyPair(symbol, ratePrecision, pipsPosition, priceRespository) {
        ...
        this.prices =
            Rx.Observable.defer(function () { return priceRespository.getPriceStream(_this); })
                .publish()
                .refCount();
    }
    return CurrencyPair;
...
var CurrencyPairUpdateFactory = /** @class */ (function () {
    ...
    CurrencyPairUpdateFactory.prototype.create = function (currencyPairUpdate) {
        ...
        var update = new CurrencyPairUpdate(currencyPairUpdate.UpdateType == UpdateTypeDto.Added ? UpdateType.Add : UpdateType.Remove, cp);
        return update;
    };
...
var ExecutionRepository = /** @class */ (function () {
    ...
    ExecutionRepository.prototype.executeRequest = function (executablePrice, notional, dealtCurrency) {
        ...
        return this._executionServiceClient.executeRequest(request)
            .select(function (tradeDto) { return _this._tradeFactory.create(tradeDto); })
...
var PriceRepository = /** @class */ (function () {
    ...
    PriceRepository.prototype.getPriceStream = function (currencyPair) {
        var _this = this;
        return Rx.Observable.defer(function () { return _this._pricingServiceClient.getSpotStream(currencyPair.symbol); })
            .select(function (p) { return _this._priceFactory.create(p, currencyPair); })
            .catch(function (ex) {
            ...
            .select(function (s) { return (s.isStale ? new StalePrice(currencyPair) : s.update); })
            .publish()
            .refCount();
    };
...
var ReferenceDataRepository = /** @class */ (function () {
    ...
    ReferenceDataRepository.prototype.getCurrencyPairsStream = function () {
        var _this = this;
        return Rx.Observable.defer(function () { return _this._referenceDataServiceClient.getCurrencyPairUpdatesStream(); })
            .where(function (updates) { return updates.length > 0; })
            .select(function (updates) { return _this.createCurrencyPairUpdates(updates); })
...
var TradeRepository = /** @class */ (function () {
    ...
    TradeRepository.prototype.getTradesStream = function () {
        var _this = this;
        return Rx.Observable.defer(function () { return _this._blotterServiceClient.getTradesStream(); })
            .select(function (trades) { return _this.createTrades(trades); })
            .catch(function () { return Rx.Observable.return([]); })
            .repeat()
            .publish()
            .refCount();
    };
...
var ServiceClientBase = /** @class */ (function () {
    ...
    ServiceClientBase.prototype.getResilientStream = function (streamFactory, connectionTimeoutMs) {
        var activeConnections = this._connectionProvider.getActiveConnection()
            .selectMany(function (connection) { return connection.status; }, function (connection, status) {
            return { c: connection, s: status };
        })
            .where(function (t) { return t.s.connectionStatus == ConnectionStatus.Connected
            || t.s.connectionStatus == ConnectionStatus.Reconnected; })
            .select(function (t) { return t.c; })
            .publish()
            .refCount();
        ...
        var firstDisconnection = firstConnection.selectMany(function (connection) { return connection.status; }, function (connection, status) {
            return { c: connection, s: status };
        })
            .where(function (t) { return t.s.connectionStatus == ConnectionStatus.Reconnecting ||
        ...
        var subsequentConnection = activeConnections.skip(1).select(function (_) { }).take(1);
        // OnError when we get 1 or 2
        var disconnected = firstDisconnection.merge(subsequentConnection)
            .select(function (_) { return Rx.Notification.createOnError(new TransportDisconnectedException("Connection was closed.")); })
            .dematerialize();
        // create a stream which will OnError as soon as the connection drops
        return firstConnection.selectMany(function (connection) { return streamFactory(connection); })
            .merge(disconnected)
            .publish()
            .refCount();
    };
    ServiceClientBase.prototype.requestUponConnection = function (factory, timeoutMs) {
        return this._connectionProvider.getActiveConnection().take(1).timeout(timeoutMs)
            .selectMany(function (c) { return factory(c); })
            .cacheFirstResult();
    };
...
var BlotterServiceClient = /** @class */ (function (_super) {
    ...
    BlotterServiceClient.prototype.getTradesStream = function () {
        var _this = this;
        return _super.prototype.getResilientStream.call(this, function (connection) { return _this.getTradesStreamFromConnection(connection); }, 5000);
    };
    BlotterServiceClient.prototype.getTradesStreamFromConnection = function (connection) {
        return Rx.Observable.create(function (observer) {
            ...
            connection.blotterHubProxy.invoke("SubscribeTrades")
                .done(function (_) { return console.log("Subscribed to blotter"); })
                .fail(function (ex) { return observer.onError(ex); });
            var unsubscriptionDisposable = Rx.Disposable.create(function () {
                ...
                connection.blotterHubProxy.invoke("UnsubscribeTrades")
                    .done(function (_) { return console.log("Unsubscribed from blotter stream."); })
                    .fail(function (ex) { return console.error("An error occured while unsubscribing from blotter:" + ex); });
            });
...
var ExecutionServiceClient = /** @class */ (function (_super) {
    ...
    ExecutionServiceClient.prototype.executeRequest = function (tradeRequest) {
        var _this = this;
        return this.requestUponConnection(function (connection) { return _this.executeForConnection(tradeRequest, connection.executionHubProxy); }, 500);
    };
    ExecutionServiceClient.prototype.executeForConnection = function (tradeRequest, executionHub) {
        return Rx.Observable.create(function (observer) {
            executionHub.invoke("Execute", tradeRequest)
                .done(function (trade) { return observer.onNext(trade); })
                .fail(function (error) { return observer.onError(error); });
...
var PricingServiceClient = /** @class */ (function (_super) {
    ...
    PricingServiceClient.prototype.getSpotStream = function (currencyPair) {
        var _this = this;
        return _super.prototype.getResilientStream.call(this, function (connection) { return _this.getSpotStreamForConnection(currencyPair, connection); }, 5000);
    };
    PricingServiceClient.prototype.getSpotStreamForConnection = function (currencyPair, connection) {
        return Rx.Observable.create(function (observer) {
            ...
            connection.pricingHubProxy.invoke("SubscribePriceStream", subscriptionRequest)
                .done(function (_) { return console.log("Subscribed to " + currencyPair); })
                .fail(function (ex) { return observer.onError(ex); });
            var unsubsciptionDisposable = Rx.Disposable.create(function () {
                connection.pricingHubProxy.invoke("UnsubscribePriceStream", subscriptionRequest)
                    .done(function (_) { return console.log("Unsubscribed from currency pair '" + currencyPair + "' stream."); })
                    .fail(function (error) { return console.log("An error occured while sending unsubscription request for " + currencyPair + ":" + error); });
            });
...
var ReferenceDataServiceClient = /** @class */ (function (_super) {
    ...
    ReferenceDataServiceClient.prototype.getCurrencyPairUpdatesStream = function () {
        var _this = this;
        return this.getResilientStream(function (connection) { return _this.getCurrencyPairUpdatesForConnection(connection); }, 5000);
    };
    ReferenceDataServiceClient.prototype.getCurrencyPairUpdatesForConnection = function (connection) {
        return Rx.Observable.create(function (observer) {
            var currencyPairUpdateSubscription = connection.currencyPairUpdates.subscribe(function (currencyPairUpdate) { return observer.onNext([currencyPairUpdate]); });
            console.log("Sending currency pair subscription...");
            connection.referenceDataHubProxy
                .invoke("GetCurrencyPairs")
                .done(function (currencyPairs) {
...
var Connection = /** @class */ (function () {
    function Connection(address, username) {
        ...
        this._hubConnection
            .disconnected(function () { return _this.changeStatus(ConnectionStatus.Closed, ConnectionType.None); })
            .connectionSlow(function () { return _this.changeStatus(ConnectionStatus.ConnectionSlow, _this.getConnectionType()); })
            .reconnected(function () { return _this.changeStatus(ConnectionStatus.Reconnected, _this.getConnectionType()); })
            .reconnecting(function () { return _this.changeStatus(ConnectionStatus.Reconnecting, ConnectionType.None); })
    ...
    Connection.prototype.initialize = function () {
        var _this = this;
        return Rx.Observable.create(function (observer) {
            _this.changeStatus(ConnectionStatus.Connecting, ConnectionType.None);
            console.log("Connecting to " + _this._address + "...");
            _this._hubConnection.start()
                .done(function () {
                _this.changeStatus(ConnectionStatus.Connected, _this.getConnectionType());
                observer.onNext(true);
                console.log("Connected to " + _this._address + ".");
            })
                .fail(function () {
                _this.changeStatus(ConnectionStatus.Closed, ConnectionType.None);
    ...
    Connection.prototype.installListeners = function () {
        ...
        this._pricingHubProxy.on("OnNewPrice", function (price) { return _this._allPrices.onNext(price); });
        this._referenceDataHubProxy.on("OnCurrencyPairUpdate", function (currencyPairs) { return _this._currencyPairUpdates.onNext(currencyPairs); });
        this._blotterHubProxy.on("OnNewTrade", function (trades) { return _this._allTrades.onNext(trades); });
    };
    return Connection;
}());
...
var ConnectionProvider = /** @class */ (function () {
    ...
    ConnectionProvider.prototype.createConnectionSequence = function () {
        ...
        return Rx.Observable.create(function (o) {
            ...
            var statusSubscription = connection.status.subscribe(function (_) { }, function (ex) {
                console.error(ex);
                o.onCompleted();
            }, function () {
            ...
            var connectionSubscription = connection.initialize().subscribe(function (_) { return o.onNext(connection); }, function (ex) {
...
var BlotterViewModel = /** @class */ (function () {
    ...
    BlotterViewModel.prototype.loadTrades = function () {
        ...
        this._tradesSubscription = this._tradeRepository.getTradesStream()
            .subscribe(function (trades) { return _this.addTrades(trades); }, function (ex) { return console.error("an error occured within the trade stream", ex); });
    };
...
var ConnectivityStatusViewModel = /** @class */ (function () {
    function ConnectivityStatusViewModel(reactiveTrader, priceLatencyRecorder) {
        ...
        this._connectionStatusSubscription = reactiveTrader.connectionStatusStream
            .subscribe(function (status) { return _this.onStatusChanged(status); }, function (ex) { return console.error("An error occured within the connection status stream", ex); });
        this._timerSubscription = Rx.Observable
            .timer(1000, Rx.Scheduler.timeout)
            .repeat()
            .subscribe(function (_) { return _this.onTimerTick(); });
    }
...
var ShellViewModel = /** @class */ (function () {
    function ShellViewModel(spotTiles, blotter, connectivityStatus, sessionExpirationService, reactiveTrader) {
        ...
        sessionExpirationService.getSessionExpiredStream()
            .subscribe(function () { return _this.onSessionExpired(); });
    }
...
var OneWayPriceViewModel = /** @class */ (function () {
    ...
    OneWayPriceViewModel.prototype.onExecute = function () {
        ...
        this._executablePrice.execute(this._parent.notional(), this._parent.dealtCurrency)
            .subscribe(function (trade) { return _this.onExecuted(trade); }, function (ex) { return _this.onExecutionError(ex); });
    };
...
var PricingViewModel = /** @class */ (function () {
    ...
    PricingViewModel.prototype.subscribeForPrices = function () {
        ...
        var subscription = this._currencyPair.prices
            .subscribe(function (price) { return _this.onPrice(price); }, function (ex) { return console.error(ex); });
...
var SpotTilesViewModel = /** @class */ (function () {
    function SpotTilesViewModel(referenceDataRepository, pricingViewModelFactory) {
        ...
        this._subscriptionModeDisposable = this._config.config().subscriptionMode
            .subscribe(function (subscriptionMode) {
            // TODO
        });
        this._executionModeDisposable = this._config.config().executionMode
            .subscribe(function (executionMode) {
            // TODO
        });
        this.loadSpotTiles();
    }
    ...
    SpotTilesViewModel.prototype.loadSpotTiles = function () {
        ...
        this._currencyPairsSubscription = this._referenceDataRepository.getCurrencyPairsStream()
            .subscribe(function (currencyPairs) { return currencyPairs.forEach(function (cp) { return _this.handleCurrencyPairUpdate(cp); }); }, function (ex) { return console.error("Failed to get currencies", ex); });
    };
    SpotTilesViewModel.prototype.handleCurrencyPairUpdate = function (update) {
        var spotTileViewModel = ko.utils.arrayFirst(this.spotTiles(), function (stvm) { return stvm.currencyPair == update.currencyPair.symbol; });
    ...
    SpotTilesViewModel.prototype.disconnect = function () {
        ko.utils.arrayForEach(this.spotTiles(), function (spotTile) { return spotTile.disconnect(); });
...
var SpotTileViewModel = /** @class */ (function () {
    function SpotTileViewModel(currencyPair, subscriptionMode, pricingFactory) {
        ...
        this.state = ko.observable(TileState.Pricing);
    ...
    SpotTileViewModel.prototype.onTrade = function (trade) {
        ...
        Rx.Observable.timer(3000, Rx.Scheduler.timeout)
            .subscribe(function (_) { return _this.dismissAffirmation(); });
    };
    ...
    Object.defineProperty(ReactiveTrader.prototype, "connectionStatusStream", {
        get: function () {
            return this._connectionProvider.getActiveConnection()
                .select(function (c) { return c.status; })
                .switchLatest()
                .publish()
                .refCount();
        },
